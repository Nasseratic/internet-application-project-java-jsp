                    ...
                    <div class="demo-card-square mdl-card mdl-shadow--2dp" style="width: 100%;">
                        ...
                        <div class="mdl-card__supporting-text">
                            <div class="mdl-textfield mdl-js-textfield" style="font-size: 20px;">
                                <input class="mdl-textfield__input" type="text" style="font-size: 20px;" name="username" id="sample1">
                                <label  style="font-size: 20px;" class="mdl-textfield__label" for="sample1"> Username.. </label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield" style="font-size: 20px;">
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="font-size: 20px;">
                                <input class="mdl-textfield__input" type="text" style="font-size: 20px;" name="phone" id="sample1">
                                <label  style="font-size: 20px;" class="mdl-textfield__label" for="sample1"> Phone Number .. </label>
                            </div>
                        </div>
